...
public class IntermediateEnemyMonster extends EnemyMonster{
	int[] enemyWidth;
	int detectedEnemyWidth;
	// 생성자
	// 이미지, 체력, 위치좌표, 처치시 보상, 사거리, 어느 stage에 나오는지 구분하는 변수, 속도, 공격력, 소모하는 자원, 공격하는 간격을 매개변수로 삼는다 	
	public IntermediateEnemyMonster(Image image, int health, Point location, int coin, int range, int speed,
